...
const cmd = command(
  ...
  flag('--asset-catalog <path>', 'The Apple asset catalog'),
  flag('--icon-name <name>', 'The icon name within the Apple asset catalog'),
  flag('--identifier <id>', 'The unique application identifier'),
  flag('--info-plist <path>', 'The Apple Info.plist template'),
  flag('--android-manifest <path>', 'The Android manifest template'),
  flag('--appx-manifest <path>', 'The Windows AppxManifest.xml template'),
  flag('--desktop-entry <path>', 'The Linux desktop entry template'),
  flag('--category <name>', 'A Linux desktop entry category').multiple(),
  flag('--resources <path>', 'The Android resources directory'),
  flag('--compatibility <name>', 'Apply compatibility patches').choices(['snap']),
  flag('--minimum-version <version>', 'The minimum supported platform version'),
